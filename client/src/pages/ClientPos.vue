    ...
    socket.onmessage = (event) => {
      try {
        ...
        if (data.type === 'NEW_ORDER') {
          // SKIP the alert if this order was generated by your own client session
          if (data.clientUid && data.clientUid === Token) {
            return; // Silently refresh orders without popping up an annoying alert
          }
